            ...
            <form @submit.prevent="onSubmit" action="" class="grid gap-y-4">
                ...
                <div class="grid gap-2">
                    ...
                    <div class="flex gap-x-2" v-else>
                        <img v-for="img in mainImagePreview" :src="img" class="h-40 w-auto object-cover border" />
                    </div>
                </div>
                <div class="grid gap-2">
                    <template v-if="!form.subImages">
                        <Label for="mImage">Sub Images</Label>
                        <FileUploader @on-change="onSubImageChange" @on-drop="onSubImageDrop" :multiple="true" />
                    </template>
                    <div class="grid grid-cols-2 gap-x-2 flex-wrap" v-else>
                        <img v-for="img in subImagesPreviews" :src="img" class="h-40 w-auto object-cover border" />
                    </div>
                </div>
                <div class="grid gap-2">
